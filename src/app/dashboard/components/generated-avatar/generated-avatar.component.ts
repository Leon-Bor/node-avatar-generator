...
export class GeneratedAvatarComponent
  ...
  ngOnInit() {
    this.route.params.subscribe((params) => {
      ...
      this.href =
        ...
        "/twitter";
      this.href =
        "https://twitter.com/intent/tweet?button_hashtag=BohnenGenerator&hashtags=rbtv&ref_src=twsrc%5Etfw&url=" +
        this.href;
    });

    this.meta.addTag({
      property: "og:description",
      content: "Erstelle deinen eigenen Bohnen-Avatar",
    });
    this.meta.addTag({ property: "og:image", content: this.link });
    this.meta.addTag({
      property: "og:title",
      content: "Bohnen Avatar Generator",
    });
