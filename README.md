...
For every combination of the 2 characters can be used 1 image.
If a image for a character combination is not existing, it will fallback to the categorie default image.
The categories are located in `/server/public/images/bvatar`. Within these categories(dirs) you have to place the images.
